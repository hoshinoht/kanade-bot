/* Dialogs, and the Limits page's live updates.
 *
 * Every control on the portal is a real form or link, so this file only
 * upgrades two interactions: a link that points at a <dialog> opens it as a
 * modal instead of scrolling to it, and the Limits page listens for server-sent
...
(function () {
  ...
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", watchLive);
  } else {
    watchLive();
  }
